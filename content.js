...
const activeChatSelector = '._210SC [aria-selected="true"]';

const closeButton = $.parseHTML(`<div class="PVMjB">
<button class="t4a8o" id="close-chat">
...
</path></svg></span></button><span></span></div>`);
...
const closeChat = () => {
  ...
  $(activeChatSelector).children().removeClass('_13opk');
...
const reopenChat = () => {
  ...
  $(activeChatSelector).addClass('_13opk');
}
